...
@section('admin')
    ...
    <br> <div class="col-lg-8">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{url('setups/designate/update/'.$selected_designation->id)}}" id="AddDesignation" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control"  value="{{$selected_designation->name}}" required type="text" id="name" name="name">
                                </div>
                            </div>
                            @error('name')
    ...
    <div class="col-12 mt-5 ">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">All Available Designations</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
