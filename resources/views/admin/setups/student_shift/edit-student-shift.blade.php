...
@section('admin')
    ...
    <br> <div class="col-lg-8">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{url('setups/student-shift/update/'.$selected_shift->id)}}" id="UpdateStudentShift" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control"  required type="text" value="{{$selected_shift->name}}" id="name" name="name">
                                </div>
                            </div>
                            @error('name')
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary">Update Student Shift</button>
                    </div>
                </form>
            </div>
        </div>
