...
@section('admin')
    ...
    <br> <div class="col-lg-8">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{url('setups/student-class/update/'.$selected_class->id)}}" id="AddStudentClass" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control"  required type="text" id="name" value="{{$selected_class->name}}" name="name">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <button type="submit" class="btn btn-primary">Update Student Class</button>
                    </div>
                </form>
            </div>
        </div>
