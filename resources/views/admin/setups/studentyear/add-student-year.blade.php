    ...
    <br> <div class="col-lg-8">
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title">Add New Student Year</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{route('add.student.year')}}" id="AddStudentYear" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Enter Student Year</label>
                                <div class="form-group">
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary">Add Student year</button>
                    </div>
                </form>
            </div>
        </div>
