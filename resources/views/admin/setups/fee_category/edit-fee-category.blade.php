...
@section('admin')
    ...
    <br> <div class="col-lg-8">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{url('setups/fee-category/update/'.$selected_fee_category->id)}}" id="AddStudentClass" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Enter Fee Category</label>
                                <div class="form-group">
                                    <input class="form-control"  required type="text" value="{{$selected_fee_category->name}}" id="name" name="name">
                                </div>
                            </div>
                            @error('name')
    ...
    <div class="col-12 mt-5 ">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">All Available Fee Categories</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
