                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    @foreach($all_students as $key=> $student)
                                        <tr>
                                            ...
                                            <td>{{(float)$registration_fee->fee_amount - ($registration_fee->fee_amount * ($student['studentDiscount']['discount_amount'])/100) .'$' }}</td>
                                            <td>
                                                <a class="btn btn-sm btn-success'" title="Payslip" target="_blank" href="{{route('student.registration.fee.payslip',[$student->student_id,$student->class_id])}}">Fee Slip</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
